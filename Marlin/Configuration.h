...
#define CUSTOM_MACHINE_NAME "Muset MK3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 400, 4000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.96 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      62    // (°C) Default bed temperature for the G26 Mesh Validation Tool.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE    7   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
